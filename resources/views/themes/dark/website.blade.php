            ...
            <div class="p-6 space-y-6">
                <div class="space-y-2">
                    ...
                    <p class="text-lg"><strong>Website:</strong>
                        @if($business->website)
                        <a href="{{ $business->website }}" target="_blank" class="text-blue-400 underline">
                            {{ $business->website }}
                        </a>
                        @else N/A @endif
                    </p>
                ...
                <div>
                    ...
                    <div class="border border-gray-700 rounded p-3 mb-3 bg-gray-800">
                        <p class="text-sm font-semibold text-white">{{ $review['author_name'] }} – {{ $review['rating'] }}⭐</p>
